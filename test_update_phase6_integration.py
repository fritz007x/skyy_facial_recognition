...
def test_wake_word_routing():
    ...
    config_file = Path("gemma_mcp_prototype/config.py")
...
def test_main_integration():
    ...
    main_file = Path("gemma_mcp_prototype/main.py")
...
def test_consistency_with_other_features():
    ...
    update_orch = Path("gemma_mcp_prototype/modules/update_orchestrator.py")
    reg_orch = Path("gemma_mcp_prototype/modules/registration_orchestrator.py")
    del_orch = Path("gemma_mcp_prototype/modules/deletion_orchestrator.py")
